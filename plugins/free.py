...
async def dailygiftt(app,query):
    ...
    if x !=None:
        ...
        keys_1  = mk(
                [
                    [btn('رشق تعليقات', 'comments'), btn(' رشق تصويتات', 'force')],
                    [btn('رشق استفاء ', 'poll'), btn(' رشق مشاهدات ', 'views')],
                    [btn('رشق ردود افعال عشوائي', 'reactions')],
                    [btn('رشق ردود افعال اختياري', 'reactions_one')],
                    [btn('رشق ردود افعال ايجابي 👍 ❤️ 🔥 😱 🤩 🤯', 'positive')],
                    [btn('رشق ردود افعال سـلـبي 👎 🤬 🤪 🍌 🥴 💩', 'negative')],
                    [btn('رشق روابط دعوة بدون اشتراك اجبارى', 'sendbot')],
                    [btn('رشق مستخدمين البوت', 'userbot')],
                    [btn('رشق توجيهات علي منشور القناة', 'forward')],
                    [btn('رجوع', 'service')]
                ]
            )
        rk = '''
    **• يمكنك استعمال هذه الخدمات في البوت بما انك مستخدم** : `مجاني`
        '''
