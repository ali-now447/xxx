...
@app.on_callback_query(filters.regex("^reactions_one$"))
        ...
        if ask.text:
            ...
            if ask1.text and "t.me" in ask1.text:
                ...
                try:
                    ...
                    print(e)
                    await ask1.reply("المنشور محذوف ، تاكد من الرابط واعد المحاولة ")
                    return
            ...
            try:
                ...
                for e in b.reactions:
                  ...
                  print("h")
            mm = "• إرسل الملصق المراد ارساله ك ردود فعل\n• على الرسالة\n• يمكن إختيار أحد الملصقات وأرسالها ↯\n• ⋯ • ⋯ • ⋯ • ⋯ • ⋯ •• ⋯ • ⋯ • ⋯ • ⋯ •\n"
            for i in xx:
                mm+=f'{i}'
            ask5 = await app.ask(user_id, mm,filters=filters.user(user_id))
            like = ask5.text
            for i in range(count):
                try:
                    o = await reactioneee(ses[i], str(channel), int(post), str(like))
