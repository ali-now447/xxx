...
@app.on_callback_query(filters.regex("^forceview$"))
            ...
            if cou >200:
                ...
                if ask2.text and "t.me" in ask2.text:
                    ...
                    try:
                        ...
                        return
                    x = int(count) * int(force_price_rea)  / 2
                    y = 0
                    ses = db.get("sessions")
                    ...
                    for i in range(count):
                        try:
                            ...
                            ooo =await view(ses[i], str(channel), int(post))
                        ...
                        if o:
                            ...
                            continue
                    for j in range(y):
                        user_info['coins'] = int(user_info['coins']) - int(force_price_rea) 
